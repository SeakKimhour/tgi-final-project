...
namespace postgresqlTest.DataModels
{
    internal class CustomerInfoModel
    {
        ...
        public CustomerInfoModel(string cs_id, string cs_national_id, string cs_phone_number, string cs_room_number, DateTime cs_checkin_date, DateTime cs_checkout_date, int cs_number_day, int cs_number_adult, int cs_number_children, string cs_discount, double cs_advance_payment, string cs_names)
        {
        ...
        public string cs_discount { get; set; }
